        ...
        >
          ...
          >
            ...
            <div className="legal-modal__body">
              ...
              <section className="legal-modal__section">
                <h3>5. Consent for AI-Generated Calls (TCPA Compliance)</h3>
              ...
              <section className="legal-modal__section">
                <h3>6. Subscription, Pricing, and Payment</h3>
              ...
              <section className="legal-modal__section">
                ...
                <h4>15.3 Class Action Waiver</h4>
