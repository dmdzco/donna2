        ...
        class _CombinedMocks:
            ...
            def __enter__(self):
                ...
                patch_specs = [
                    ...
                    ("processors.conversation_director.analyze_queries", AsyncMock(return_value={"memory_queries": []}), False),
                    ...
                    ("services.director_llm.analyze_queries", AsyncMock(return_value={"memory_queries": []}), False),
