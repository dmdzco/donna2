...
Donna's forward voice workflow assumes **Telnyx for phone voice and media streaming**, **Claude Haiku 4.5 for the live voice LLM**, **Gemini 3 Flash Preview for completed-call analysis**, **ElevenLabs Flash for TTS**, and **email/in-app caregiver notifications only**. SMS is intentionally inactive for now. Using measured production speech volume from **March 16, 2026 through April 15, 2026** as the baseline, the current modeled stack costs about **$0.43 per 10-minute completed outbound call**, or **$0.043 per live call minute**, before customer support, payroll, App Store fees, payment processing, compliance counsel, or CAC.
...
| Telnyx + Deepgram Aura-1 | $7.98 | $13.30 | $17.29 |
| Telnyx STT + Telnyx TTS evaluation | $8.79 | $14.65 | $19.05 |
...
| Telnyx + Deepgram Aura-1 | 72% | 54% | 40% |
| Telnyx STT + Telnyx TTS evaluation | 70% | 49% | 34% |
...
| Telnyx + Deepgram Aura-1 | $17.29 | 65% |
| Telnyx STT + Telnyx TTS evaluation | $19.05 | 61% |
