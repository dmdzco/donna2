        ...
        >
          ...
          >
            ...
            <div className="legal-modal__header">
              ...
              <p className="legal-modal__meta">Effective Date: March 28, 2026 &nbsp;·&nbsp; Last Updated: March 28, 2026</p>
            </div>

            <div className="legal-modal__body">

              <section className="legal-modal__section">
                <h3>1. Introduction and Who We Are</h3>
                <p>Donna (&ldquo;Donna,&rdquo; &ldquo;we,&rdquo; &ldquo;us,&rdquo; or &ldquo;our&rdquo;) is an AI-powered companion calling service that provides scheduled, personalized phone calls to seniors on behalf of their family caregivers. We are operated by Donna, reachable at <a href="mailto:nick@calldonna.co">nick@calldonna.co</a>.</p>
                ...
                <div className="legal-modal__notice" style={{ marginTop: '8px' }}>
              ...
              <section className="legal-modal__section">
                ...
                <h4>2.2 Information Generated Through Service Use</h4>
                <ul>
              ...
              <section className="legal-modal__section">
                <h3>4. Call Recordings and Transcripts</h3>
              ...
              <section className="legal-modal__section">
                <h3>5. License to Use Your Data</h3>
              ...
              <section className="legal-modal__section">
                ...
                <h4>6.1 Service Providers (Processors)</h4>
              ...
              <section className="legal-modal__section">
                <h3>7. TCPA Consent and Automated Calls</h3>
                ...
                <p>You or the Call Recipient may stop all calls at any time by managing settings in the app or by contacting <a href="mailto:nick@calldonna.co">nick@calldonna.co</a>.</p>
              </section>
              ...
              <section className="legal-modal__section">
                ...
                <p>To exercise any of these rights, contact us at <a href="mailto:nick@calldonna.co">nick@calldonna.co</a>. We will respond within 30 days. We will not discriminate against you for exercising your rights.</p>
